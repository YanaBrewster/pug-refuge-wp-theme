    ...
    <nav class="top-nav">
      ...
      <div class="row">
        ...
        <div class="col-4 col-xs-4 col-sm-4 col-md-4 col-lg-12">
          <a class="navbar-brand center-l" href="<?php echo home_url(); ?>">
        ...
        <!-- Shopping cart -->
        <div class="col-3 col-xs-3 col-sm-3 col-md-3 col-lg-3 mt-2  mt-xs-2 mt-sm-2  mt-md-2">
